...
if (isset($_GET['recipe_id'])) {
    ...
    if (isset($_POST['commentSubmit'])) {
        ...
        $sql = "INSERT INTO comments (comment, recipe_id, user_Id, date) VALUES ('$message', '$recipe_id', '$user_Id', '$date')";
    ...
    if (isset($_POST['deleteComment'])) {
        ...
        if (!$result) {
            ...
            header("Location: recipedetailspagec&r.php?recipe_id=$recipe_id");
            exit();
        }
    }
}
